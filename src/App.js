...
import {HeaderGrandChild} from './components/Header/Header.jsx' // eslint-disable-line no-unused-vars
import {LessTestComponent} from './components/LessTestComponent/LessTestComponent.jsx' // eslint-disable-line no-unused-vars
...
export class App extends React.Component{
  render () {
    return (
      <div>
        <HeaderGrandChild name='ComponentHeader'/>
        <LessTestComponent/>
